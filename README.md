...
<table>
<tr>
<td><img src="docs/images/store-1-fight.png" width="240" alt="A firefight over a brown floor, plasma and fireballs in flight, corpses where the fight has already been"></td>
<td><img src="docs/images/store-2-creature.png" width="240" alt="The marine facing a creature twice his size, medical kits and corpses between them"></td>
<td><img src="docs/images/store-3-floors.png" width="240" alt="The same fight on a green floor, which is what the difficulty looks like from outside"></td>
</tr>
<tr>
<td><img src="docs/images/settings-1-visual.png" width="240" alt="Frame rate and sprite zoom as rows of buttons, and switches for the health readout and god mode"></td>
<td><img src="docs/images/settings-2-sprites.png" width="240" alt="The background as a dungeon floor, a flat colour from the WAD palette or an image, and the choice between the bundled Freedoom sprites and your own WAD"></td>
<td><img src="docs/images/settings-3-statistics.png" width="240" alt="One row per creature: its sprite, how many the marine has killed, and in red how many times it has killed him"></td>
</tr>
</table>
